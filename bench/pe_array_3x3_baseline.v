`timescale 1ns/1ps
// VARIANT B array: identical to pe_array_3x3 in every way EXCEPT the
// multiplier instance. Same ports, same adder tree, same bias, same ReLU,
// same 2-stage pipeline -- so any difference measured is the multiplier alone.
module pe_array_3x3_baseline #(
    parameter WGT_FILE  = "",
    parameter BIAS_FILE = "",
    parameter LUT_FILE  = ""
)(
